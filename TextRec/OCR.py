...
from DB.Db import add_score, slack_detect_new_img
...
#     img_gray = cv2.threshold(img_gray, 140, 255, cv2.THRESH_BINARY)[1]
...
def score_listening_mode(playerid: str) -> str:
    ...
    while True:
        ...
        if time_elapsed > 1 / frame_rate:
            ...
            text = reader.readtext(frame)[0][1]
            ...
            if fuzz.partialratio(text, "Game Over") > 70:
                for i in range(60):
                    if slack_detect_new_img():
                        score_img = open('/home/felipe/PinballProject/SlackImages/score.jpg', 'rb')
                        score = reader.readtext(score_img)[0][1]
...
def main():
    ...
    # img_path = '/home/felipe/Downloads/PinballScreenshots/2.png'
    #
