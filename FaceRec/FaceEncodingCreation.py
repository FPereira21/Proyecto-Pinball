...
def main():
    ...
    for image_path, image_name in zip(photo_list, photo_name):
        tmp_img = face_recognition.load_image_file(image_path)
        tmp_location = face_recognition.face_locations(tmp_img)
        tmp_img_encoding = face_recognition.face_encodings(tmp_img, tmp_location)[0]
